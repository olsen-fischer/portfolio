document.addEventListener('DOMContentLoaded', function () {
  const menuIcon = document.getElementById('menu-icon'); // Hamburger menu
  const nav = document.querySelector('.nav'); // Navigation menu

  menuIcon.addEventListener('click', function () {
      nav.classList.toggle('show'); // Toggle the navigation menu
...
window.onscroll = () =>{
 ...
 var typed = new Typed('.multiple-text', {
    strings: ['Web Developer', 'Data Analyst', 'Graphic Designer', 'Virtual Assistant'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 100,
     loop: true
